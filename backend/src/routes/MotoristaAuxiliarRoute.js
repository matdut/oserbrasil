...
const MotoristaAuxiliarController = require('../controllers/MotoristaAuxiliarController');
...
router.put('/update/:id', MotoristaAuxiliarController.update);
router.get('/getEmail/:email', MotoristaAuxiliarController.getEmail);
router.delete('/delete/:id',MotoristaAuxiliarController.delete);
router.get('/getMotoristaCpf/:cpf', MotoristaAuxiliarController.getMotoristaCpf);
router.post('/file/upload', multer(multerConfig).single('file'), MotoristaAuxiliarController.upload);
//router.post('/foto/update/:id', multer(multerConfig).single('file'), MotoristaController.uploadFotoFiles);
router.put('/foto/update/:id', MotoristaAuxiliarController.uploadFotoFiles);
//router.put('/documentoCNH/update/:id', multer(multerConfig).single('file'), MotoristaController.uploadCNHFiles);
router.put('/documentoCNH/update/:id', MotoristaAuxiliarController.uploadCNHFiles);
/*

...
class listComponent extends React.Component  {
  ...
  loadMotivosCancelamento(){ 
    ...
    api.get('/motivo_cancelamento/list')
    .then(res=>{
      if (res.data.success) {
        const data = res.data.data
        this.setState({listaMotivos:data})
      }
      else {
  ...
  sendSave(){       
    ...
    const datapost = {
      descricao: this.state.campDescricao,
          ...
          api.post('/motivo_cancelamento/create',datapost)
          .then(response=>{
            if (response.data.success) {                   
           
             this.loadMotivosCancelamento();  
             this.setState({                
                mensagem_usuario: 'Motivo incluído com sucesso!'
               });
  ...
  //  const classes = useStyles();
      ...
      <div>   
          <Menu_administrador />  
            <div className="titulo_lista">
              ...
              <div className="titulo_bemvindo"> Motivos Cancelamento </div>
              </div>      
            </div>
            <br/>
               ...
               <MaterialTable          
                   ...
                   localization={{
                     ...
                     toolbar: {
                       ...
                       searchPlaceholder: 'Buscar Motivo Cancelamento',        
                     },
                     pagination: {
                 ...
                 />      
                  <div className="botao_lista_incluir">
                   <Fab style={{ textTransform: 'capitalize',  outline: 'none'}} className="tamanho_botao" size="large" color="secondary" variant="extended" onClick={()=>this.handleOpenModalInclusao()}>
                       <AddIcon/> <div className="botao_incluir"> Adicionar Motivo Cancelamento </div>
                   </Fab>
                 </div>                        
        </div>  
   ...
   ><div className="editar_titulo_inclusao"> Incluir Motivos Cancelamento    
...
<ReactModal 
   ...
   ><div> 
       ...
       <div className="container_alterado">              
        ...
        <div className="moldura_modal_delecao">
          <div className="titulo_moldura_modal_delecao">Deseja mesmo excluir este Motivo Cancelamento? </div>
 ...
 // </div>
  ...
  sendDelete(userId){  
    ...
    api.delete(`/motivo_cancelamento/delete/${userId}`)
    .then(response =>{
      if (response.data.success) {
        ...
        this.setState({       
          mensagem_usuario: 'Motivo excluído com sucesso!'
         });

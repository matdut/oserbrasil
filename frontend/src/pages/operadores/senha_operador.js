...
class empresarialComponent extends React.Component{  
  ...
  constructor(props){
    ...
    this.carrega_operador = this.carrega_operador.bind(this);
...
verificar_menu() {   
  ...
  } else if (localStorage.getItem('logperfil') == 8) { // CLIENTE MOTORISTA
    ...
    return(
      <div className="d-flex justify-content-around">
          <div className="botao_navegacao">
               ...
               <div>
                 <div className="titulo_representante">                
                  <label>  {this.verifica_nome(this.state.campNome)}, Altere a sua senha  </label>       
                 </div>
               </div>   

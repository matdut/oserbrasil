   ...
   if (localStorage.getItem('logperfil') == 0) {
      if (inicio == 1) {
        return (
          ...
          <Box bgcolor="text.disabled" color="background.paper" className="botao_alterar_doc_foto"  p={2}>
          ...
          //  console.log(JSON.stringify(' validacao campo ', null, "    "));
            if (this.state.foto1State == 'has-success' && this.state.foto2State == 'has-success') {
              ...
              return (
                <Box bgcolor="error.main" color="error.contrastText" className="botao_alterar_doc_foto_habilitado" p={2} onClick={()=>this.sendUpdate()}>
                <div className="d-flex justify-content-center">
                <label> Próximo </label>
                </div>     
                </Box>           

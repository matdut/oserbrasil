...
fileChangedHandler = (event) => {
         ...
         <br/>
            ...
            <div className="form-row">         
                ...
                <Button color="primary" variant="contained"                         
                 ...
                 Incluir o carro  <Icon className="fa fa-plus-circle" />
                 </Button>                  
                  <Modal 
                  ...
                  >
                   ...
                   <div className="form-row">    
                    ...
                    <button type="text" className="btn btn-primary" onClick={()=>this.salvar_carro()}>Cadastrar</button>   
 ...
 loadCarrosData(){
  ...
  return this.state.listacarros.map((data, index)=>{
    return(
      <tr>
        <th>{index + 1}</th>          
        <td>{data.carro}</td>

      ...
      <div>
        <div className="d-flex justify-content-around">
             <div className="botao_navegacao">                               
               ...
               <div>
                  <div className="botao_navegacao">
                  <Link to='/listar'><img className="botao_close espacamento_seta" src="../close_black.png"/> </Link>                        
                  </div>   
               </div>                     
        </div>      
          <br/>    
    ...
    return(
      <div className="d-flex justify-content-around">
              <div className="botao_navegacao">                            
               ...
               <div>
                  <div className="botao_navegacao">
                  <Link to='/area_motorista'><img className="botao_close espacamento_seta" src="../close_black.png"/> </Link>                                 
                  </div>   
               </div>   

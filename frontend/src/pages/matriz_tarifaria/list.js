...
class listaMatrizComponent extends React.Component  {
  ...
  constructor(props){
    ...
    this.percentualchange = this.percentualchange.bind(this);
    this.descricaoChange = this.descricaoChange.bind(this);
    this.descricaotaxaChange = this.descricaotaxaChange.bind(this);
  ...
  percentualchange(e) {
    this.setState({ camppercentual: valorMask(e.target.value) })  
  }
  descricaotaxaChange(e) {
    this.setState({ campDescricao1: e.target.value })  
  }
  descricaoChange(e) {
    this.setState({ campDescricaodesconto: e.target.value })  
  }
...
verificahora_final(e) {  
      ...
      pedagio: 0.00
          ...
          .then(response=>{
            ...
            if (response.data.success==true) {     
              ...
              this.setState({                   
                mensagem_usuario: 'Diária alterada com sucesso!',          
              });     
    
              this.handleCloseModalEditarDiaria();
              this.envia_mensagemEdicaoClick();     
  ...
  sendSaveTaxa(){         
    ...
    const datapost = {
       percentual: valorDoublemask(this.state.camppercentual),
       descricao: this.state.campdescricao1,      
    }          
        
    console.log('sendSaveTaxa - '+JSON.stringify(datapost, null, "    ")); 

          api.post('/taxas/create', datapost)          
          .then(response=>{         
            
            if (response.data.success==true) {            

              this.setState({                   
                mensagem_usuario: 'Taxa incluída com sucesso!',          
              });     
    
              this.loadTaxas();
              this.handleCloseModalIncluirTaxa();
               this.envia_mensagemInclusaoClick();                
  ...
  sendUpdateTaxa(data){           
    ...
    const datapost = {
       ...
       descricao: this.state.campdescricao1,      
          ...
          api.put(`/taxas/update/${this.state.taxaupdateId}`, datapost)          
          .then(response=>{         
            
            if (response.data.success==true) {            

              this.setState({                   
                mensagem_usuario: 'Taxa Alterada com sucesso!',          
              });     
    
              this.loadTaxas();
              this.handleCloseModalTaxaAlterar();
               this.envia_mensagemInclusaoClick();                
  ...
  sendSaveDesconto(){           
    ...
    const datapost = {
      qtd_servico_inicial: this.state.campfaixa_inicial,
      qtd_servico_final: this.state.campfaixa_final,
      percentual: valorDoublemask(this.state.camppercentual),      
    }          
        
          api.post('/descontos/create', datapost)          
          .then(response=>{         
            
            if (response.data.success==true) {            

              this.setState({                   
                mensagem_usuario: 'Desconto incluído com sucesso!',          
              });     
    
              this.loadDescontos();
              this.handleCloseModalIncluirDesconto();
              this.envia_mensagemInclusaoClick();             
  ...
  sendUpdateDesconto(data){           
    ...
    const datapost = {
      ...
      percentual: valorDoublemask(this.state.camppercentual),      
          ...
          api.put(`/descontos/update/${this.state.descontoupdateId}`, datapost)          
          .then(response=>{         
            
            if (response.data.success==true) {            

              this.setState({                   
                mensagem_usuario: 'Desconto Alterado com sucesso!',          
              });     
    
              this.loadDescontos();
              this.handleCloseModalDescontoAlterar();
              this.envia_mensagemInclusaoClick();             
  ...
  sendSaveDiaria(){           
    ...
    const datapost = {
      ...
      pedagio: 0.00
          ...
          api.post('/diaria/create', datapost)          
          .then(response=>{
            ...
            if (response.data.success==true) {                                      
              ...
              this.setState({                   
                mensagem_usuario: 'Diária incluída com sucesso!',          
              });     
    
              this.handleCloseModalIncluirDiaria();
              this.envia_mensagemInclusaoClick();               
      ...
      pedagio: 0.00
          ...
          .then(response=>{
            ...
            if (response.data.success==true) {                                      
              ...
              this.setState({                   
                mensagem_usuario: 'Diária Especial alterada com sucesso!',          
              });     
    
              this.handleCloseModalDiariaEspecialE();
              this.envia_mensagemEdicaoEspecialClick();     
  ...
  sendSaveDiariaEspecial(){           
    ...
    const datapost = {
      ...
      pedagio: 0.00
          ...
          api.post('/diariaEspecial/create', datapost)          
          .then(response=>{      
            ...
            if (response.data.success==true) {                                      
              ...
              this.setState({                   
                mensagem_usuario: 'Diária Especial incluída com sucesso!',          
              });     
    
              this.handleCloseModalDiariaEspecial();
...
verifica_botao_alteracao_diaria(inicio) {
  const { validate } = this.state   
  //console.log('validate - '+JSON.stringify(this.state, null, "    ")); 
      ...
      if (this.state.validacao_faixa_1 == true && this.state.validacao_faixa_2 == true 
        ...
        && this.state.validacao_valorkm == true && this.state.validacao_valortempo == true) { 
          return (
            ...
            <Box bgcolor="text.disabled" color="background.paper" className="botoes_habilitados_modal"  p={2} onClick={()=>this.sendUpdateAlteracaoDiaria()}>
                    <div className="d-flex justify-content-center">
                    <label> Salvar Alterações </label>
                    </div>     
              </Box>           
...
verifica_botao_alterar_Taxa(inicio) {
  const { validate } = this.state   
  //console.log('validate - '+JSON.stringify(this.state, null, "    ")); 

     if (this.state.camppercentual !== '' ) { 
          return (
      
            <Box bgcolor="text.disabled" color="background.paper" className="botoes_habilitados_modal"  p={2} onClick={()=>this.sendUpdateTaxa()}>
                    <div className="d-flex justify-content-center">
                    <label> Alterar </label>
                    </div>     
              </Box>           
...
verifica_botao_alterar_desconto(inicio) {
  const { validate } = this.state   
  //console.log('validate - '+JSON.stringify(this.state, null, "    ")); 

  if (this.state.camppercentual !== '' && this.state.campfaixa_inicial !== "" && this.state.campfaixa_final !== "" ) { 
          return (
      
            <Box bgcolor="text.disabled" color="background.paper" className="botoes_habilitados_modal"  p={2} onClick={()=>this.sendUpdateDesconto()}>
                    <div className="d-flex justify-content-center">
                    <label> Alterar </label>
                    </div>     
              </Box>           
...
verifica_botao_inclusao_Taxa(inicio) {
  const { validate } = this.state   
  //console.log('validate - '+JSON.stringify(this.state, null, "    ")); 
     ...
     if (this.state.camppercentual !== '' ) { 
          return (
            ...
            <Box bgcolor="text.disabled" color="background.paper" className="botoes_habilitados_modal"  p={2} onClick={()=>this.sendSaveTaxa()}>
                    <div className="d-flex justify-content-center">
                    <label> Incluir </label>
                    </div>     
              </Box>           
...
verifica_botao_inclusao_Desconto(inicio) {
  const { validate } = this.state   
  //console.log('validate - '+JSON.stringify(this.state, null, "    ")); 
     ...
     if (this.state.camppercentual !== '' && this.state.campfaixa_inicial !== "" && this.state.campfaixa_final !== "" ) { 
          return (
            ...
            <Box bgcolor="text.disabled" color="background.paper" className="botoes_habilitados_modal"  p={2} onClick={()=>this.sendSaveDesconto()}>
                    <div className="d-flex justify-content-center">
                    <label> Incluir </label>
                    </div>     
              </Box>           
...
verifica_botao_inclusao_diaria(inicio) {
  const { validate } = this.state   
  //console.log('validate - '+JSON.stringify(this.state, null, "    ")); 
      ...
      if (this.state.validacao_faixa_1 == true && this.state.validacao_faixa_2 == true 
        ...
        && this.state.validacao_valorkm == true && this.state.validacao_valortempo == true) { 
          return (
            ...
            <Box bgcolor="text.disabled" color="background.paper" className="botoes_habilitados_modal"  p={2} onClick={()=>this.sendSaveDiaria()}>
                    <div className="d-flex justify-content-center">
                    <label> Incluir </label>
                    </div>     
              </Box>           
...
botao_inclusao_diaria_especial(inicio) {
  const { validate } = this.state   
  //console.log('validate - '+JSON.stringify(this.state, null, "    ")); 
      ...
      if (this.state.validacao_faixa_1 == true && this.state.validacao_faixa_2 == true 
        ...
        && this.state.validacao_hora_inicial == true && this.state.validacao_hora_final == true ) { 
          return (
            ...
            <Box bgcolor="text.disabled" color="background.paper" className="botoes_habilitados_modal"  p={2} onClick={()=>this.sendSaveDiariaEspecial()}>
                    <div className="d-flex justify-content-center">
                    <label> Incluir </label>
                    </div>     
              </Box>           
...
botao_diaria_especial_E(inicio) {
  const { validate } = this.state   
  //console.log('validate - '+JSON.stringify(this.state, null, "    ")); 
      ...
      if (this.state.validacao_faixa_1 == true && this.state.validacao_faixa_2 == true 
        ...
        && this.state.validacao_hora_inicial == true && this.state.validacao_hora_final == true ) { 
          return (
            ...
            <Box bgcolor="text.disabled" color="background.paper" className="botoes_habilitados_modal"  p={2} onClick={()=>this.sendUpdateDiariaEspecial()}>
                    <div className="d-flex justify-content-center">
                    <label> Salvar Alterações </label>
                    </div>     
              </Box>           
  ...
  loadDescontos(){
    ...
    api.get("/descontos/list")
     .then(res=>{  
       if (res.data.success) {
         const data = res.data.data        
         this.setState({listaDescontos:data})    
       }
     })
     .catch(error=>{
       alert("Error lista descontos "+error)
     })
   }
   ...
   loadTaxas(){
    ...
    api.get("/taxas/list")
     .then(res=>{  
       if (res.data.success) {
         const data = res.data.data        
         this.setState({listaTaxas:data})    
       }
     })
     .catch(error=>{
       alert("Error lista taxas "+error)
     })
   }
  loadDiaria(){
    ...
    api.get("/diaria/list")
     .then(res=>{  
       if (res.data.success) {
         const data = res.data.data        
         this.setState({listaDiaria:data})    
       }
     })
     .catch(error=>{
       alert("Error lista matriz "+error)
   ...
   loadDiariaEspecial(){
    ...
    api.get("/diariaEspecial/list")
     .then(res=>{  
       if (res.data.success) {
         const data = res.data.data        
         this.setState({listaDiariaEspecial:data})
...
<br/>
    ...
    <div className="container-fluid">                                       
            ...
            <AppBar position="static" color="transparent">
              <TabList onChange={this.opcao_tabChange} aria-ltabs_titulo_lista_tarifasabel="simple tabs example">           
                <Tab label="Tarifa" value="1" className="tabs_titulo_lista_tarifas"/>
                <Tab label="Tarifa Especial" value="2" className="tabs_titulo_lista_tarifas"/>     
                <Tab label="Diária" value="3" className="tabs_titulo_lista_tarifas"/>
                <Tab label="Diária Especial" value="4" className="tabs_titulo_lista_tarifas"/>        
                <Tab label="Taxa" value="5" className="tabs_titulo_lista_tarifas"/>
                <Tab label="Descontos" value="6" className="tabs_titulo_lista_tarifas"/>                
              </TabList>
            </AppBar>        
          ...
          <div>
            ...
            <div>
                    <MaterialTable          
                        ...
                        columns={[
                          { title: '', field: '#', width: "55px", minWidth: '55px', maxWidth: '55px', },
                          { title: 'Transporte', field: 'tipoTransporte', width: '140px', minWidth: '140px', maxWidth: '140px', 
                          render: rowData => rowData.tipoTransporte.substr(0,20) },                                     
                          ...
                          { title: 'Hr Inicial', field: 'hora_inicial', width: '85px', minWidth: '85px', maxWidth: '85px', align: 'right' ,
                          render: rowData => rowData.hora_inicial.substring(0,5)},
                          { title: 'Hr Final', field: 'hora_final', width: '75px', minWidth: '75px', maxWidth: '75px', align: 'right',
                          ...
                          render: rowData =>  valorMask(rowData.valor_tempo) },                          
                          { title: 'Bandeirada (R$)', field: 'bandeira', width: '125px', minWidth: '125px', maxWidth: '125px', align: 'right' ,
                          render: rowData =>  valorMask(rowData.bandeira) },                          
                          { title: 'Receptivo (R$)', field: 'receptivo', width: '120px', minWidth: '120px', maxWidth: '120px', align: 'right' ,
                          render: rowData =>  valorMask(rowData.receptivo) }, 
                          { title: 'Bilingue (%)', field: 'bilingue', width: '120px', minWidth: '120px', maxWidth: '120px', align: 'center' },                                                  
          ...
          <div>
                    <MaterialTable          
                        ...
                        columns={[                                                    
                          ...
                          render: rowData =>  valorMask(rowData.receptivo) }, 
                          { title: 'Bilingue (%)', field: 'bilingue', width: '150px', minWidth: '150px', maxWidth: '150px', align: 'center' },                                            
                          { title: '', field: '', lookup: { 1: 'sadas', 2: 'asdas' }, },              
                        ]}
                        data={this.state.listaDiaria}     
                        localization={{
                          body: {
                            emptyDataSourceMessage: 'Nenhum registro para exibir',
                            addTooltip: 'Adicionar Valores Tarifários',
                          ...
                          toolbar: {
                            searchTooltip: 'Pesquisar',
                            searchPlaceholder: 'Buscar Diária',        
                          },
                          pagination: {
                            labelRowsSelect: 'linhas',
                            labelDisplayedRows: '{count} de {from}-{to}',
                        ...
                        actions={[
                          {             
                            icon: 'edit',
                            onClick: (evt, data) => this.handleOpenModalEditarDiaria(data)
                          },
                          {
                            icon: 'delete',                                                             
                            tooltip: 'Deleta Diária',          
                            onClick: (evt, data) => this.handleOpenModalDiariaDelete(data)                                     
                          }
                          /*,
                          {
                            icon: 'add',                                                             
             ...
             <div className="botao_lista_incluir">
                        <Fab style={{ textTransform: 'capitalize',  outline: 'none'}} className="tamanho_botao" size="large" color="secondary" variant="extended" onClick={()=>this.handleOpenModalIncluirDiaria()}>
                            <AddIcon/> <div className="botao_incluir"> Adicionar Diária  </div>
                        </Fab>
                      </div>  
            ...
            <div>
                    <MaterialTable          
                        ...
                        columns={[
                          ...
                          { title: 'Receptivo (R$)', field: 'receptivo', width: '120px', minWidth: '120px', maxWidth: '120px', align: 'right' ,
                          render: rowData =>  valorMask(rowData.receptivo) }, 
                          { title: 'Bilingue (%)', field: 'bilingue', width: '140px', minWidth: '140px', maxWidth: '140px', align: 'center' },                                                   
                          { title: '', field: '', lookup: { 1: 'sadas', 2: 'asdas' }, },        
                        ]}
                        data={this.state.listaDiariaEspecial}     
                        localization={{
                          body: {
                            emptyDataSourceMessage: 'Nenhum registro para exibir',
                            addTooltip: 'Adicionar Valores Tarifários',
                          ...
                          toolbar: {
                            searchTooltip: 'Pesquisar',
                            searchPlaceholder: 'Buscar Diária Especial',        
                          },
                          pagination: {
                            labelRowsSelect: 'linhas',
                            labelDisplayedRows: '{count} de {from}-{to}',
                      ...
                      //    cellStyle:{ position: 'fixed' },
                        ...
                        actions={[
                          {             
                            icon: 'edit',
                            onClick: (evt, data) => this.handleOpenModalDiariaEspecialE(data)
                          },
                          {
                            icon: 'delete',                                                             
                            tooltip: 'Deleta Tarifa',          
                            onClick: (evt, data) => this.handleOpenModalDiariaEspecialDelete(data)                                     
                          }
                          /*,
                          {
                            icon: 'add',                                                             
             ...
             <div className="botao_lista_incluir">
                        <Fab style={{ textTransform: 'capitalize',  outline: 'none'}} className="tamanho_botao" size="large" color="secondary" variant="extended" onClick={()=>this.handleOpenModalDiariaEspecial()}>
                            <AddIcon/> <div className="botao_incluir"> Adicionar Diária Especial </div>
                        </Fab>
                      </div>  
            </TabPanel>
            <TabPanel value="5" className="tirar_espaco">            
            <div>
                    <MaterialTable          
                        title=""                     
                        columns={[
                          { title: '', field: '#', width: "55px", minWidth: '55px', maxWidth: '55px', },
                          { title: 'Descrição', field: 'descricao', width: '250px', minWidth: '250px', maxWidth: '250px' },                           
                          { title: 'Percentual (%)', field: 'percentual', width: '140px', minWidth: '140px', maxWidth: '140px', align: 'right',
                          render: rowData =>  valorMask(rowData.percentual) },                                                   
                          { title: '', field: '#', width: "180px", minWidth: '180px', maxWidth: '180px' },
                          { title: '', field: '#', width: "280px", minWidth: '280px', maxWidth: '280px' },
                          { title: '', field: '#', width: "285px", minWidth: '285px', maxWidth: '285px' },
                          { title: '', field: '', lookup: { 1: 'sadas', 2: 'asdas' }, },        
                        ]}
                        data={this.state.listaTaxas}     
                        localization={{
                          body: {
                            emptyDataSourceMessage: 'Nenhum registro para exibir',
                            addTooltip: 'Adicionar Valores Tarifários',
                          ...
                          toolbar: {
                            searchTooltip: 'Pesquisar',
                            searchPlaceholder: 'Buscar Taxas',        
                          },
                          pagination: {
                            labelRowsSelect: 'linhas',
                            labelDisplayedRows: '{count} de {from}-{to}',
                      ...
                      //    cellStyle:{ position: 'fixed' },
                        ...
                        actions={[
                          {             
                            icon: 'edit',
                            onClick: (evt, data) => this.handleOpenModalTaxaAlterar(data.id)
                          },
                          {
                            icon: 'delete',                                                             
                            tooltip: 'Deleta Taxa',          
                            onClick: (evt, data) => this.handleOpenModalTaxaDelete(data)                                     
                          }
             ...
             <div className="botao_lista_incluir">
                        <Fab style={{ textTransform: 'capitalize',  outline: 'none'}} className="tamanho_botao" size="large" color="secondary" variant="extended" onClick={()=>this.handleOpenModalIncluirTaxa()}>
                            <AddIcon/> <div className="botao_incluir"> Adicionar Taxa </div>
                        </Fab>
                      </div>  
            </TabPanel> 
            <TabPanel value="6" className="tirar_espaco">            
            <div>          
                    <MaterialTable          
                        title=""                     
                        columns={[
                          { title: '', field: '#', width: "55px", minWidth: '55px', maxWidth: '55px' },
                          { title: 'Qtd de serviços (De)', field: 'qtd_servico_inicial', width: '200px', minWidth: '200px', maxWidth: '200px', align: 'right'},
                          { title: 'Qtd de serviços (Até)', field: 'qtd_servico_final', width: '200px', minWidth: '200px', maxWidth: '200px', align: 'right'}, 
                          { title: 'Percentual de desconto (%)', field: 'percentual', width: '280px', minWidth: '280px', maxWidth: '280px', align: 'right',                           
                          render: rowData =>  valorMask(rowData.percentual)},                                                   
                          { title: '', field: '#', width: "200px", minWidth: '200px', maxWidth: '200px' },
                          { title: '', field: '#', width: "255px", minWidth: '255px', maxWidth: '255px' },
                          { title: '', field: '', lookup: { 1: 'sadas', 2: 'asdas' }, },            
                        ]}
                        data={this.state.listaDescontos}     
                        localization={{
                          body: {
                            emptyDataSourceMessage: 'Nenhum registro para exibir',
                            addTooltip: 'Adicionar Valores Tarifários',
                      ...
                      //    cellStyle:{ position: 'fixed' },
                        ...
                        actions={[
                          {             
                            icon: 'edit',
                            onClick: (evt, data) => this.handleOpenModalDescontoAlterar(data.id)
                          },
                          {
                            icon: 'delete',                                                             
                            tooltip: 'Deleta Tarifa',          
                            onClick: (evt, data) => this.handleOpenModalDescontoDelete(data)                                     
                          }
                          /*,
                          {
                            icon: 'add',                                                             
             ...
             <div className="botao_lista_incluir">
                        <Fab style={{ textTransform: 'capitalize',  outline: 'none'}} className="tamanho_botao" size="large" color="secondary" variant="extended" onClick={()=>this.handleOpenModalIncluirDesconto()}>
                            <AddIcon/> <div className="botao_incluir"> Adicionar Desconto </div>
                        </Fab>
                      </div>  
            </TabPanel>
           </TabContext>          
     ...
     <ReactModal 
        isOpen={this.state.showModalInclusaoTaxa}
        style={customStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div className="editar_titulo_inclusao"> Incluir Taxa
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalIncluirTaxa()} className="botao_close_modal_tarifarios">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <div className="container_modal_alterado">
            <div className="d-flex justify-content font_modal_padrao">                 
                 <div class="d-flex flex-column espacamento_caixa_modal">                               
                          ...
                          <FormControl variant="outlined" className="posicao_caixa_texto">
                              ...
                              <OutlinedInput  
                                 ...
                                 // readOnly="true"                   
                                  ...
                                  id="outlined-basic"                   
                                  variant="outlined"
                                  value={this.state.campdescricao1}                                           
                     ...
                     <div class="p-2">    
                        <div class="d-flex justify-content-start">
                              <div>
                              <FormControl className="input_matriz_direita" variant="outlined">
                                  <InputLabel className="label_matriz_direita" htmlFor="standard-adornment-amount">Percentual</InputLabel>
                                  <OutlinedInput                                   
                                    className="input_matriz_direita"
                                    id="standard-adornment-amount"
                                    error={this.state.erro_bilingue} 
                                    ...
                                    autoComplete='off'
                                    autoCorrect='off'
                                    value={this.state.camppercentual}                                  
                                  
                                    onChange={(e) => {
                                      this.percentualchange(e)                                    
                                    }}                                                                          
                                    inputProps={{
                                      maxLength: 5,
                                    }}                                     
                   ...
                   {this.verifica_botao_inclusao_Taxa(this.state.inicio)}     
     ...
     <ReactModal 
        isOpen={this.state.showMensagemTaxaAlterar}
        style={customStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div className="editar_titulo_inclusao"> Alterar Taxa
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalTaxaAlterar()} className="botao_close_modal_tarifarios">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <div className="container_modal_alterado">
            <div className="d-flex justify-content font_modal_padrao">                 
                 <div class="d-flex flex-column espacamento_caixa_modal">                               
                   ...
                   {this.verifica_botao_alterar_Taxa(this.state.inicio)}     
     ...
     <ReactModal 
        isOpen={this.state.showMensagemDescontoAlterar}
        style={customStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div className="editar_titulo_inclusao"> Alterar Desconto
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalDescontoAlterar()} className="botao_close_modal_tarifarios">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <div className="container_modal_alterado">
            <div className="d-flex justify-content font_modal_padrao">                 
                 <div class="d-flex flex-column espacamento_caixa_modal">                                                    
                      ...
                      <div class="p-2">               
                          <div class="d-flex justify-content-start">
                              <div> 
                              <FormControl className="input_matriz_direita" variant="outlined">
                                  <InputLabel className="label_matriz_direita" htmlFor="standard-adornment-amount">Qtd de serviços (Até)</InputLabel>
                                  <OutlinedInput
                                   className="input_matriz_direita"
                                    id="standard-adornment-amount"  
                                    error={this.state.erro_faixa_2} 
                              ...
                              <div>
                              <FormControl className="input_matriz_esquerda" variant="outlined">
                                  <InputLabel className="label_matriz_esquerda" htmlFor="standard-adornment-amount">Qtd de serviços (De)</InputLabel>
                                  <OutlinedInput
                                    className="input_matriz_esquerda"                                    
                                    id="standard-adornment-amount"  
                                    error={this.state.erro_faixa_2} 
                     ...
                     <div class="p-2">    
                        <div class="d-flex justify-content-start">
                              <div>
                              <FormControl className="input_matriz_direita" variant="outlined">
                                  <InputLabel className="label_matriz_direita" htmlFor="standard-adornment-amount">Percentual de desconto (%)</InputLabel>
                                  <OutlinedInput                                   
                                    className="input_matriz_direita"
                                    id="standard-adornment-amount"
                                    error={this.state.erro_bilingue} 
                   ...
                   {this.verifica_botao_alterar_desconto(this.state.inicio)}     
     ...
     <ReactModal 
        isOpen={this.state.showModalInclusaoDesconto}
        style={customStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div className="editar_titulo_inclusao"> Incluir Desconto
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalIncluirDesconto()} className="botao_close_modal_tarifarios">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <div className="container_modal_alterado">
            <div className="d-flex justify-content font_modal_padrao">                 
                 <div class="d-flex flex-column espacamento_caixa_modal">                                                    
                   ...
                   {this.verifica_botao_inclusao_Desconto(this.state.inicio)}     
     ...
     <ReactModal 
        isOpen={this.state.showModalInclusaoDiaria}
        style={customStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div className="editar_titulo_inclusao"> Incluir Diária
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalIncluirDiaria()} className="botao_close_modal_tarifarios">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <div className="container_modal_alterado">
            <div className="d-flex justify-content font_modal_padrao">        
                 ...
                 <div class="d-flex flex-column espacamento_caixa_modal">
                   ...
                   {this.verifica_botao_inclusao_diaria(this.state.inicio)}     
                </div>
              </div>        
            </div>
     </ReactModal>   
     <ReactModal 
        isOpen={this.state.showModalEditarDiaria}
        style={customStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div className="editar_titulo_inclusao"> Editar Diária             
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalEditarDiaria()} className="botao_close_modal_editar_tarifarios">
              <CloseOutlinedIcon />
            </IconButton></div>               
            ...
            <div className="container_modal_alterado">
               <div className="d-flex justify-content font_modal_padrao">        
                 ...
                 <div class="d-flex flex-column espacamento_caixa_texto">              
                   ...
                   {this.verifica_botao_alteracao_diaria(this.state.inicio)}     
                </div>
              </div>        
            </div>
     </ReactModal>    
      ...
      <ReactModal 
        isOpen={this.state.showModalDiariaEspecial}
        style={customStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div className="editar_titulo_inclusao"> Incluir Diaria Especial            
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalDiariaEspecial()} className="botao_close_modal_tarifarios_esp">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <div className="container_alterado">
               <div className="d-flex justify-content">        
                 ...
                 <div class="d-flex flex-column espacamento_caixa_texto font_modal">
                    ...
                    {this.botao_inclusao_diaria_especial(this.state.inicio)}     
                </div>
              </div>        
            </div>
     </ReactModal>
     ...
     <ReactModal 
        isOpen={this.state.showModalDiariaEspecialE}
        style={customStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div className="editar_titulo_inclusao"> Editar Diária Especial            
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalDiariaEspecialE()} className="botao_close_modal_tarifarios_esp">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <div className="container_alterado">
               <div className="d-flex justify-content">        
                 ...
                 <div class="d-flex flex-column espacamento_caixa_texto font_modal">
                   ...
                   {this.botao_diaria_especial_E(this.state.inicio)}     
                </div>
              </div>        
            </div>
     </ReactModal>
     ...
     <ReactModal 
        isOpen={this.state.showMensagemDiariaDelete}
        style={ConfirmacaodelStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div> 
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalDiariaDelete()} className="botao_close_modal_deletar">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <center><img src="/exclamation.png" /> </center>
            <div className="container_alterado">              
             ...
             <div className="moldura_modal_delecao">
               <div className="titulo_moldura_modal_delecao">Deseja mesmo excluir esta Diária? </div>
               <div>Ao confirmar a exclusão o registro será apagado.  </div>
             </div>     
                <div className="retorno">{this.state.retorno}</div>
            <Box 
               className="botoes_delete_cancelar_modal" p={2} onClick={()=>this.handleCloseModalDiariaDelete()}>
              <div className="d-flex justify-content-center">
              <label> Cancelar </label>
              </div>     
            </Box>      
            <Box 
               className="botoes_delete_excluir_modal" p={2} onClick={()=>this.sendDeleteDiaria(this.state.campDeletarId)}>
              <div className="d-flex justify-content-center">
              <label> Excluir </label>
              </div>     
            </Box>      
     ...
     <ReactModal 
        isOpen={this.state.showMensagemDiariaEspecialDelete}
        style={ConfirmacaodelStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div> 
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalDiariaEspecialDelete()} className="botao_close_modal_deletar">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <center><img src="/exclamation.png" /> </center>
            <div className="container_alterado">              
             ...
             <div className="moldura_modal_delecao">
               <div className="titulo_moldura_modal_delecao">Deseja mesmo excluir esta Diária Especial? </div>
               <div>Ao confirmar a exclusão o registro será apagado.  </div>
             </div>     
                <div className="retorno">{this.state.retorno}</div>
            <Box 
               className="botoes_delete_cancelar_modal" p={2} onClick={()=>this.handleCloseModalDiariaEspecialDelete()}>
              <div className="d-flex justify-content-center">
              <label> Cancelar </label>
              </div>     
            </Box>      
            <Box 
               className="botoes_delete_excluir_modal" p={2} onClick={()=>this.sendDeleteDiariaEspecial(this.state.campDeletarId)}>
              <div className="d-flex justify-content-center">
              <label> Excluir </label>
              </div>     
            </Box>      
     ...
     <ReactModal 
      ...
      <ReactModal 
        isOpen={this.state.showMensagemTaxaDelete}
        style={ConfirmacaodelStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div> 
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalTaxaDelete()} className="botao_close_modal_deletar">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <center><img src="/exclamation.png" /> </center>
            <div className="container_alterado">              
             ...
             <div className="moldura_modal_delecao">
               <div className="titulo_moldura_modal_delecao">Deseja mesmo excluir esta Taxa? </div>
               <div>Ao confirmar a exclusão o registro será apagado.  </div>
             </div>     
                <div className="retorno">{this.state.retorno}</div>
            <Box 
               className="botoes_delete_cancelar_modal" p={2} onClick={()=>this.handleCloseModalTaxaDelete()}>
              <div className="d-flex justify-content-center">
              <label> Cancelar </label>
              </div>     
            </Box>      
            <Box 
               className="botoes_delete_excluir_modal" p={2} onClick={()=>this.sendDeleteTaxa(this.state.campDeletarId)}>
              <div className="d-flex justify-content-center">
              <label> Excluir </label>
              </div>     
            </Box>      
     ...
     <ReactModal 
        isOpen={this.state.showMensagemDescontoDelete}
        style={ConfirmacaodelStyles}
        contentLabel="Inline Styles Modal Example"                                  
        ><div> 
            <IconButton aria-label="editar" onClick={()=>this.handleCloseModalDescontoDelete()} className="botao_close_modal_deletar">
              <CloseOutlinedIcon />
            </IconButton></div>       
            <center><img src="/exclamation.png" /> </center>
            <div className="container_alterado">              
             ...
             <div className="moldura_modal_delecao">
               <div className="titulo_moldura_modal_delecao">Deseja mesmo excluir esta Desconto? </div>
               <div>Ao confirmar a exclusão o registro será apagado.  </div>
             </div>     
                <div className="retorno">{this.state.retorno}</div>
            <Box 
               className="botoes_delete_cancelar_modal" p={2} onClick={()=>this.handleCloseModalDescontoDelete()}>
              <div className="d-flex justify-content-center">
              <label> Cancelar </label>
              </div>     
            </Box>      
            <Box 
               className="botoes_delete_excluir_modal" p={2} onClick={()=>this.sendDeleteDesconto(this.state.campDeletarId)}>
              <div className="d-flex justify-content-center">
              <label> Excluir </label>
              </div>     
            </Box>      
  ...
  handleOpenModalEditarDiaria(data) { 
    this.setState({ 
      showModalEditarDiaria: true,
      mensagem_aguarde: '',
      inicio: 2
    });  
    sessionStorage.setItem('logmatrizId', data.id);    
  ...
  handleCloseModalEditarDiaria() {
    this.setState({ 
      showModalEditarDiaria: false
    });
  ...
  handleOpenModalIncluirTaxa() { 
    this.setState({ 
      showModalInclusaoTaxa: true,
      mensagem_aguarde: '',
      camppercentual: '',
      campdescricao1: 'Taxa do Cartão de Crédito',
    });              
  //  this.limpar_campos();  

  }
  
  handleCloseModalIncluirTaxa() {
    this.setState({ 
      showModalInclusaoTaxa: false
    });
  ...
  handleOpenModalIncluirDesconto() { 
    this.setState({ 
      showModalInclusaoDesconto: true,
      mensagem_aguarde: '',
      camppercentual: '', 
    });              
    this.limpar_campos();  
  ...
  handleCloseModalIncluirDesconto() {
    this.setState({ 
      showModalInclusaoDesconto: false
    });
  ...
  handleOpenModalIncluirDiaria() { 
    this.setState({ 
      showModalInclusaoDiaria: true,
      mensagem_aguarde: ''
    });              
    this.limpar_campos();
    this.loadTipoTransporte();    
  ...
  handleCloseModalIncluirDiaria() {
    this.setState({ 
      showModalInclusaoDiaria: false
    });
  ...
  handleOpenModalDiariaEspecial(data) { 
    this.setState({ 
      showModalDiariaEspecial: true,
      mensagem_aguarde: '',
      inicio: 2
    });  
  ...
  handleCloseModalDiariaEspecial() {
    this.setState({ 
      showModalDiariaEspecial: false
    });
  ...
  handleCloseModalTaxas() {
    this.setState({ 
      showModalTaxas: false
    });
  ...
  handleOpenModalDescontos(data) { 
    this.setState({ 
      showModalDescontos: true,
      mensagem_aguarde: '',
      inicio: 2
    });  
  ...
  handleOpenModalDiariaEspecialE(data) { 
    this.setState({ 
      showModalDiariaEspecialE: true,
      mensagem_aguarde: '',
      inicio: 2
    });  
    sessionStorage.setItem('logmatrizId', data.id);    
  ...
  handleCloseModalDiariaEspecialE() {
    this.setState({ 
      showModalDiariaEspecialE: false
    });
  ...
  handleOpenModalDiariaDelete(data) { 
    this.setState({ 
      showMensagemDiariaDelete: true,
      campDeletarId: data.id,
      retorno: '',
      campDescricao: '',
      validacao_descricao: false,
  ...
  handleCloseModalDiariaDelete() {
    this.setState({ 
      showMensagemDiariaDelete: false
    });
  
   
  }

  handleOpenModalDiariaEspecialDelete(data) { 
    this.setState({ 
      showMensagemDiariaEspecialDelete: true,
      campDeletarId: data.id,
      retorno: '',
      campDescricao: '',
      validacao_descricao: false,
  ...
  handleCloseModalDiariaEspecialDelete() {
    this.setState({ 
      showMensagemDiariaEspecialDelete: false
    });
  ...
  handleOpenModalTaxaDelete(data) { 
    this.setState({ 
      showMensagemTaxaDelete: true,
      campDeletarId: data.id,
      retorno: '',
      campDescricao: '',
      validacao_descricao: false,
  ...
  handleCloseModalTaxaDelete() {
    this.setState({ 
      showMensagemTaxaDelete: false
    });
  ...
  handleOpenModalTaxaAlterar(id) { 
    debugger;
    this.setState({ 
      showMensagemTaxaAlterar: true,
      taxaupdateId: id,
     // campDeletarId: data.id,
      retorno: '',
      //campDescricao: '',
    ...
    this.carrega_taxa(id);
    
  }
 
  handleCloseModalTaxaAlterar() {
    this.setState({ 
      showMensagemTaxaAlterar: false,
      taxaupdateId: '',
    });
  ...
  handleOpenModalDescontoAlterar(id) { 
    this.setState({ 
      showMensagemDescontoAlterar: true,
    //  campDeletarId: data.id,
      retorno: '',
      descontoupdateId: id,
      validacao_descricao: false,
    ...
    this.carrega_desconto(id);
    
  }
 
  handleCloseModalDescontoAlterar() {
    this.setState({ 
      showMensagemDescontoAlterar: false,
      descontoupdateId: '',
    });
  ...
  handleOpenModalDescontoDelete(data) { 
    this.setState({ 
      showMensagemDescontoDelete: true,
      campDeletarId: data.id,
      retorno: '',
     // campDescricao: '',
      validacao_descricao: false,
  ...
  handleCloseModalDescontoDelete() {
    this.setState({ 
      showMensagemDescontoDelete: false
    });
  ...
  carrega_taxa(id) { 
    ...
    debugger;
    api.get(`/taxas/get/${id}`)
    .then(res=>{
      if (res.data.success == true) {
        const data = res.data.data

        this.setState({ 
          campdescricao1: res.data.data[0].descricao,
          camppercentual: valorMask(res.data.data[0].percentual),
         });
      }
    });  
  }
  ...
  carrega_desconto(id) { 
    api.get(`/descontos/get/${id}`)
    .then(res=>{
      if (res.data.success == true) {
        const data = res.data.data

        this.setState({ 
          campfaixa_inicial: res.data.data[0].qtd_servico_inicial,
          campfaixa_final: res.data.data[0].qtd_servico_final,
          camppercentual: valorMask(res.data.data[0].percentual),
         });
  ...
  sendDeleteDiaria(userId){
    // url de backend
   // console.log('deletar o id - '+userId);
   // const Url = baseUrl+"/cliente/delete/"+userId    // parameter data post
    // network
    api.delete(`/diaria/delete/${userId}`)
    .then(response =>{
      if (response.data.success) {       
        this.loadDiaria();   
        this.setState({  
          //open: true,
          mensagem_usuario: 'Diária Excluida com sucesso!'
         });
        this.handleCloseModalDiariaDelete(); 
        this.envia_mensagemExclusaoClick();
      }
    })
    .catch ( error => {
  ...
  sendDeleteDiariaEspecial(userId){
    // url de backend
   // console.log('deletar o id - '+userId);
   // const Url = baseUrl+"/cliente/delete/"+userId    // parameter data post
    // network
    api.delete(`/diariaEspecial/delete/${userId}`)
    .then(response =>{
      if (response.data.success) {     
        this.loadDiariaEspecial();      
        this.setState({  
         // open: true,
          mensagem_usuario: 'Diária Especial Excluida com sucesso!'
         });                   
        this.handleCloseModalDiariaEspecialDelete();   
        this.envia_mensagemExclusaoClick();
      }
    })
    .catch ( error => {
  ...
  sendDeleteDesconto(userId){
    // url de backend
   // console.log('deletar o id - '+userId);
   // const Url = baseUrl+"/cliente/delete/"+userId    // parameter data post
    // network
    api.delete(`/descontos/delete/${userId}`)
    .then(response =>{
      if (response.data.success) {       
        this.loadDescontos();   
        this.setState({  
          //open: true,
          mensagem_usuario: 'Desconto Excluido com sucesso!'
         });

        this.handleCloseModalDescontoDelete(); 
        this.envia_mensagemExclusaoClick();
      }
    })
    .catch ( error => {
  ...
  sendDeleteTaxa(userId){
    // url de backend
   // console.log('deletar o id - '+userId);
   // const Url = baseUrl+"/cliente/delete/"+userId    // parameter data post
    // network
    api.delete(`/taxas/delete/${userId}`)
    .then(response =>{
      if (response.data.success) {       
        this.loadTaxas();   
        this.setState({  
          //open: true,
          mensagem_usuario: 'Taxa Excluida com sucesso!'
         });
        this.handleCloseModalTaxaDelete(); 
        this.envia_mensagemExclusaoClick();
      }
    })
    .catch ( error => {

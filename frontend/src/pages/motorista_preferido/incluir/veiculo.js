        ...
        .then(response=>{
         ...
         // if (response.data.success==true) {                        
          ...
          //   console.log('VEICULO SUCESSO ');
              sessionStorage.setItem('logVeiculo', response.data.data[0].id)

              if (sessionStorage.getItem('logperfil') == 1) {
                this.props.history.push(`/documentos_preferido_motorista_incluir/`+sessionStorage.getItem('logid')); 
    ...
    <div>
     <div className="d-flex justify-content-around">
               <div className="botao_navegacao">
                 <Link to={`/endereco_motorista_preferido_incluir/`+sessionStorage.getItem('logid')}> <i className="fa fa-chevron-left fa-2x espacamento_seta"  aria-hidden="true"></i> </Link>
               </div>                  
               <div>

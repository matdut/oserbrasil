...
class ConfiguracaoComponent extends React.Component  {
  ...
  verificar_lista_operador() {

    if (sessionStorage.getItem('logperfil') == 1) {
      return( 
        <a href={`/operador_lista`}>
             <img src='/users-cog.png' style={{ width: '40px', height: '40px' }}/>   
        </a>   
      );
     } else if (sessionStorage.getItem('logperfil') == 7) {
       return( 
        <a href={`/operador_lista_empresa/`+sessionStorage.getItem('logid')}>
            <img src='/users-cog.png' style={{ width: '40px', height: '40px' }}/>   
        </a>   
       );    
     }
  ...
  verificar_lista_administradores() {

    if (sessionStorage.getItem('logperfil') == 1) {
      return( 
        <td>
        <div className="menu_adm_auxiliar">
           <div className="centraliza_img">
           <LightTooltip title="Administrador Auxiliar" placement="top">
      ...
      <div>    
         ...
         {this.verificar_menu_lateral()} 
          ...
          <div className="titulo_lista">
              ...
              <div className="titulo_bemvindo"> Auxiliar </div>     
              </div>      
            </div>

           <div className="titulo_lista_auxiliares">
            <table>
              <tr>             
                
                {this.verificar_lista_administradores()}
                 
                 <td>
                  <div className="menu_adm_auxiliar">
                      <div className="centraliza_img">                
                      <LightTooltip title="Operadores" placement="top">
                          {this.verificar_lista_operador()}
                      </LightTooltip>    
                    </div>
                      <div>Operadores</div>
                    </div>

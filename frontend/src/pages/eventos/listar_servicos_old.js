  ...
  loadlistServicos(){
   ...
   carregar_motorista_servico(data) {
    ...
    .then(res=>{
     ...
     // sessionStorage.get('mensagem_motorista_alocado','');
      this.setState({                           
        mensagem_motorista_alocado: this.state.mensagem_motorista_alocado        
      });
    }
   ...
   carrega_servico_visualizacao(data){
    ...
    api.get(`/historicoServicos/get/${data.id}`)
     .then(res=>{
      ...
      //     campmotoristaalocado: res.data.data[0].mensagem_motorista_alocado,      
            validacao_tipo: true, 
...
verifica_menu() {
 ...
 async verifica_veiculo_motorista_selecionados(motorista_id, tipoTransporte, servico){
  ...
  async procurar_motorista_servico(servico, tipo_solicitacao) { 
   ...
   // alert(`tipo_solicitacao - ${tipo_solicitacao}`);
...
debugger
 ...
 // return data_ultima;
  ...
  //  debugger
    ...
    } else if (this.state.campmotoristaalocado == true) {
      return (
  ...
  informacao_motorista_alocado() {
    if (this.state.campmotoristaalocado == true) {
      return (
        <div className="layout_motorista_alocado">
        <div className="d-flex">    
             <div className="p-2 layout_label_motorista_alocado">Nome: </div>    
             <div className="p-2">{this.state.campMotorista}</div>   
        </div>
        <div className="d-flex">    
             <div className="p-2 layout_label_motorista_alocado">Placa: </div>    
             <div className="p-2">{this.state.campPlaca}</div> 
        </div>
        <div className="d-flex">
            <div className="p-2 layout_label_motorista_alocado">Modelo: </div>    
            <div className="p-2">{this.state.campModelo}</div>   
        </div>
        <div className="d-flex">    
             <div className="p-2 layout_label_motorista_alocado">Cor: </div>    
  ...
  verifica_mensagem_alocado() {
    ...
    if (this.state.campmotoristaalocado == false) {
      this.setState({  
        mensagem_motorista_alocado: 'Por favor aguarde. Procurando Motorista para atender seu serviço!'      
      }); 
                    ...
                    <MaterialTable          
                          ...
                          //  isLoading={this.state.loading}       
                            ...
                            cellStyle:{ fontSize: 10}, render: rowData => rowData.servico_pai_id == 0 ? rowData.tipoEventoId == 1 ? <div style={{fontSize: 10}}>{rowData.quantidade_diarias}</div> : '' : ''},                 
                              ...
                              { title: 'Alocado', field: '', width: '48px', minWidth: '48px', maxWidth: '48px', align: 'center',
                               render: rowData => rowData.motorista_alocado == true ?  <img src='/bola-verde.png' style={{ width: '20px', height: '20px' }} onClick={()=>this.handleOpenModalMotorista(rowData)} />  : <img src='/bola-cinza.jpg' style={{ width: '25px', height: '25x' }} onClick={()=>this.handleOpenModalMotorista(rowData)}  /> },
                   ...
                   <div className="d-flex justify-content-start">
                       ...
                       <FormControl variant="outlined" className="input_modal_direita">
                          ...
                          <OutlinedInput   
                            ...
                            endAdornment={
                              <InputAdornment position="end">
                                  {this.state.validacao_telefone1? '': ''}
                              </InputAdornment>
                            }
                            labelWidth={80}                      
                          />

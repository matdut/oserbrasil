        ...
        <Collapse isOpen={this.isOpen} navbar>
          <Nav className="ml-auto" navbar>            
            ...
            <UncontrolledDropdown nav inNavbar>
              ...
              <DropdownMenu right>
                <DropdownItem href={`/cliente/`+sessionStorage.getItem('logid')}>
                <i class="far fa-user"></i> Dados Pessoais
                </DropdownItem>
                <DropdownItem href={`/cliente_endereco/`+sessionStorage.getItem('logid')}>
                <i class="fas fa-home"></i> Endereço
                </DropdownItem>
                <DropdownItem href={`/cliente_senha/`+sessionStorage.getItem('logid')}>

   ...
   buscadorcep(base.replace('-','')).
     then(endereco => {           
      ...
      .then(res=>{        
        ...
        console.log(' registros - '+JSON.stringify(res.data.data.length, null, "    "));
        if (res.data.data.length !== 0) {      
          ...
          <div id="fisica" className="container tab-pane active">
            ...
            <div className="form-row">                
                ...
                <div className="form-group col-md-3">
                  ...
                  <Input
                    type="email"
                    ref={ this.Email_confirmacao_validacao }
                    name="email2"
                    id="exampleEmail2"
                ...
                <div className="form-group col-md-3">
                  ...
                  <Input
                    type="password"
                    name="senha2"
                    ref={ this.senha_confirmacao_validacao }
                    id="exampleEmail2"
  ...
  /*          
    ...
    this.setState({ 
      ...
      this.setState({ 
        ...
        console.log(JSON.stringify('passou das validações', null, "    ")); 

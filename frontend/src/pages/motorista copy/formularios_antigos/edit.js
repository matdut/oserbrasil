...
class EditComponent extends React.Component{ 
  ...
  constructor(props){
   ...
   this.state = {
    campNome: "",
    campEmail:"",
    options: [{name: 'Inglês'},{name: 'Alemão'}, {name: 'Italiano'}, {name: 'Francês'}],
    values: [],
    selectedValue: [],
    selectValues: [],
    campEmailTeste:"",
   ...
   this.seleciona_idioma2 = this.seleciona_idioma2.bind(this);     
  ...
  .then(res=>{
    if (res.data.success) {
      ...
      this.setState({
        ...
        campModelo: data.modelo,
        campPlaca: data.placa,
        campAno: data.ano,
        campCor: data.cor,
        campMotorista_bilingue: data.bilingue == 1? true: false,
        ...
        campIdioma1: data.idioma1,      
        campIdioma2: data.idioma2,      
      })
      ...
      if (this.state.campMotorista_bilingue ) {
        this.setState({
          seleciona_limit: 2 
        });         
      }
...
handleChangeBilingue = (e) => {     
  ...
  //console.log('handleChangeBilingue - '+e.target.checked);
  //console.log('handleChangeBilingue - '+e.target.value);
...
fileChangedHandler = (event) => {
      ...
      <div className="container">                              
         <br/>
            ...
            <div className="form-row">
              ...
              <div className="form-group col-md-3">    
              <FormControlLabel
                        checked={this.state.campMotorista_bilingue}
              ...
              <div className="form-group col-md-3">    
                ...
                <Multiselect                      
                      ...
                      selectedValues={this.seleciona_idioma2} // Preselected value to persist in dropdown
 ...
 sendUpdate(){   
  const { validate } = this.state
    ...
    //console.log('atualizar1 -'+JSON.stringify(this.state.options, null, "    ") );
    console.log('atualizar1 -'+JSON.stringify(this.state.selectedValue, null, "    ") );    
    console.log('atualizar1 -'+JSON.stringify(this.state.selectedValues, null, "    ") );

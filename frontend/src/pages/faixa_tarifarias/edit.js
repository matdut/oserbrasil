...
class FaixaeditarComponent extends React.Component{ 
    ...
    constructor(props){
      ...
      componentDidMount(){  
        ...
        api.get(`/faixa/get/${faixaId}`)
        .then(res=>{
            if (res.data.success) {
              const data = res.data.data[0]
               
              this.setState({                         
                campFaixa_inicial: data.faixa_inicial, 
                campFaixa_final: data.faixa_final, 
                campValor_KM: data.valor_km, 
                campValor_tempo: data.valor_tempo,
                campMatrizId: data.matrizId
              })          
  ...
  sendUpdate(){            
    ...
    if (this.state.campFaixa_final=="") {
      ...
      api.put(`/faixa/update/${Id}`, datapost)
      .then(response=>{
...
export default FaixaeditarComponent;